            ...
            <div class=" mx-auto col-xs-12">
                <div class="card p-2">
                    ...
                    <form action="register.php" method="post" onsubmit="return validateForm()">
                        ...
                        <div class="form-inline mb-2"><span class="regiter_page"><font style="color:red">*</font><b>Password must be atleast 8 characters. Must contain a lowercase, uppercase and a special character.  </b></span></div>
