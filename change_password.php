                    ...
                    <div class="card p-2">
                        ...
                        <form action="change_password.php" method="post">
                                ...
                                <div class="form-inline">
                                    ...
                                    <span class="btn btn-pos-2 btn-pos-left btn-outline-light" ><i class="far fa-eye" id="togglePassword1" style="margin-left: -7px; cursor: pointer;" aria-hidden="true"></i></span>
                                </div>
