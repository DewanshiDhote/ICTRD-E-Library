...
<div id="minimal-bootstrap-carousel" class="carousel slide carousel-fade slider-content-style slider-home-one" >
        <div class="carousel-inner inner2">
            <div class="carousel-item active slide-1" style="background: url(./Images/banner.png)" data-interval="2000">
            ...
            <div class="carousel-item slide-2" style="background: url(./Images/banner10.png)" data-interval="2000">
                <div class="carousel-caption">
                    <div class="container">
                        <div class="row h-100">
                            <div class="col-lg-12 my-auto">
            ...
            <div class="carousel-item slide-4" style="background: url(./Images/banner6.png)" data-interval="2000">
                <div class="carousel-caption">
                    <div class="container">
                        <div class="row">
